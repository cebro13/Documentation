...
public class Movement : CoreComponent
{
    ...
    {
        //RaycastHit2D raycastHit = Physics2D.BoxCast(new Vector2(m_collider.bounds.center.x, m_collider.bounds.center.y),
        //m_collider.bounds.size, 0f, Vector2.down, floatHeight, m_stairsLayerMask);
    ...
    {
        //Gizmos.DrawWireCube(new Vector2(m_collider.bounds.center.x, m_collider.bounds.center.y - m_collider.bounds.size.y/2), new Vector2(m_collider.bounds.size.x -0.1f, m_collider.bounds.size.y/2 -0.1f));        
        //Gizmos.DrawWireSphere(m_rb.position, 2f);
    }
}
