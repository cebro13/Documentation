...
public class EP1_MeleeAttackState : MeleeAttackState
{
    private EnemyPersistant1 m_enemy;

    public EP1_MeleeAttackState(Entity entity, FiniteStateMachine stateMachine, string animBoolName, Transform attackPosition, MeleeAttackStateRefSO stateData, EnemyPersistant1 enemy):
