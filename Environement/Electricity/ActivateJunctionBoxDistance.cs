...
public class ActivateJunctionBoxDistance : MonoBehaviour, ICanInteract, ISwitchable, IDataPersistant
{
    [SerializeField] private JunctionBox m_junctionBox;
    [SerializeField] private Utils.Direction m_dir;
    [SerializeField] private bool m_deactivateAfterSwap;
    ...
    private void ActivateAnimator()
    {
        ...
        m_hasActivate = true;
        m_junctionBox.Interact(m_dir);
        if(m_deactivateAfterSwap)
        {
            m_junctionBox.DeactivateSwitchPlug();
        }
