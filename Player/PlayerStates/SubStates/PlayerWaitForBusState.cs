...
public class PlayerWaitForBusState : PlayerState
{
    ...
    public PlayerWaitForBusState(PlayerStateMachine playerStateMachine, PlayerData playerData, string animBoolName) :
