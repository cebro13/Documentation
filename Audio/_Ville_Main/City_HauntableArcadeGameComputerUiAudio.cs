...
public class City_HauntableArcadeGameComputerUiAudio : MonoBehaviour
{
    [SerializeField] private City_HauntableArcadeGameComputerScreenUI m_arcadeGameComputerUI;
    ...
    [SerializeField] EventReference m_audioSwitchGhostRef;
    [SerializeField] EventReference m_audioIncreaseSpeed;
    [SerializeField] EventReference m_audioDecreaseSpeed;
    ...
    private void Start()
    {
        ...
        m_arcadeGameComputerUI.OnSwitchGhost += ArcadeGameComputerUI_OnSwitchGhost;
        m_arcadeGameComputerUI.OnIncreaseSpeed += ArcadeGameComputerUI_OnIncreaseSpeed;
        m_arcadeGameComputerUI.OnDecreaseSpeed += ArcadeGameComputerUI_OnDecreaseSpeed;
    ...
    private void ArcadeGameComputerUI_OnSwitchGhost(object sender, EventArgs e)
    {
        AudioManager.Instance.PlayOneShot(m_audioSwitchGhostRef, transform.position);
    }

    private void ArcadeGameComputerUI_OnIncreaseSpeed(object sender, EventArgs e)
    {
        AudioManager.Instance.PlayOneShot(m_audioIncreaseSpeed, transform.position);
    }

    private void ArcadeGameComputerUI_OnDecreaseSpeed(object sender, EventArgs e)
    {
        AudioManager.Instance.PlayOneShot(m_audioDecreaseSpeed, transform.position);
    }
